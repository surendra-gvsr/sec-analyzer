...
*Note: All amounts are in millions, except per share amounts.*
...
- *Gross margin increased $9.7 billion or 29% driven by growth in Azure and the change in estimated useful lives of our server and network equipment.*
...
- *Note: Amounts are illustrative and should be replaced with actual figures from the financial statements.*
